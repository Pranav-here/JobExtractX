...
def load_evaluation_results(directory="evaluation_results/mistral_lora_eval"):
    """Load all evaluation result files in the directory."""
    result_files = glob.glob(f"{directory}/mistral_lora_eval_*.json")
...
def visualize_metrics(data):
    ...
    output_dir = "evaluation_results/mistral_lora_eval/visualizations"
