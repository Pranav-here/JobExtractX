...
if __name__ == "__main__":
    ...
    model_name = "alexlanxy/flan_t5_xl_lora_prompt_bf16_batch_2"
    ...
    import os
    os.makedirs("evaluation_results/flan_t5_xl_lora_batch_2_eval", exist_ok=True)
    
    # Save results to file
    output_file = f"evaluation_results/flan_t5_xl_lora_batch_2_eval/flan_t5_xl_lora_eval_{timestamp}.json"
