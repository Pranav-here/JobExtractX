...
model_name = "google/flan-t5-xl"  # Using XL version
...
training_args = TrainingArguments(
    output_dir="./flan_t5xl_lora_output",
    run_name="flan-t5-xl-lora-job-extraction",
    num_train_epochs=3,
...
wandb.init(project="flan-t5-job-extraction", name="flan-t5-xl-lora-training-rtx6000")
...
model_path = "./flan_t5xl_lora_final"
