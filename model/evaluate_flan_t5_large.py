...
if __name__ == "__main__":
    ...
    model_name = "alexlanxy/flan_t5_large_linkedin_prompt_ordered_fields"
    print(f"Loading model from {model_name}")
    
    tokenizer = AutoTokenizer.from_pretrained(model_name)
    
    # Load model directly (no PEFT)
    ...
    import os
    os.makedirs("evaluation_results/flan_t5_large_eval", exist_ok=True)
    
    # Save results to file
    output_file = f"evaluation_results/flan_t5_large_eval/flan_t5_large_eval_{timestamp}.json"
