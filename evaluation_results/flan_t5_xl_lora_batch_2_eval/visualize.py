...
def load_evaluation_results(directory="evaluation_results/flan_t5_xl_lora_batch_2_eval"):
...
def visualize_metrics(data):
    ...
    output_dir = "evaluation_results/flan_t5_xl_lora_batch_2_eval/visualizations"
