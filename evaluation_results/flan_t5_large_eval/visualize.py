...
def load_evaluation_results(directory="evaluation_results/flan_t5_large_eval"):
    """Load all evaluation result files in the directory."""
    result_files = glob.glob(f"{directory}/flan_t5_large_eval_*.json")
...
def visualize_metrics(data):
    ...
    output_dir = "evaluation_results/flan_t5_large_eval/visualizations"
